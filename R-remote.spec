...
Version  : 1.2.3
Release  : 43
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/remote_1.2.3.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/remote_1.2.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744639594
...
/usr/lib64/R/library/remote/NEWS.md
